 ...
 */
define( 'MULTIVER_COMMON_HOME', '/home/wikipedia/common' );
define( 'MULTIVER_COMMON_APACHE', '/usr/local/apache/common-local' );

define( 'MULTIVER_CDB_DIR_HOME', '/home/wikipedia/common' );
define( 'MULTIVER_CDB_DIR_APACHE', '/usr/local/apache/common-local' );

define( 'MULTIVER_404SCRIPT_PATH_HOME', '/home/wikipedia/common/wmf-config/missing.php' );
