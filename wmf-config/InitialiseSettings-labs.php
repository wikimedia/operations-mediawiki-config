				...
				[
					...
					'questions' => [
						[
							...
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q1',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-foundational-ce-q1-a1' ],
						...
						[
							'name' => 'reader-foundational-ce-q2',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q2',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-foundational-ce-q2-a1' ],
								[ 'label' => 'reader-foundational-ce-q2-a2' ],
								[ 'label' => 'reader-foundational-ce-q2-a3' ],
							]
						],
						[
							'name' => 'reader-foundational-ce-q3',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q3',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-foundational-ce-q3-a1' ],
								[ 'label' => 'reader-foundational-ce-q3-a2' ],
								[ 'label' => 'reader-foundational-ce-q3-a3' ],
							]
						],
						[
							...
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-foundational-ce-q4-a1' ],
								[ 'label' => 'reader-foundational-ce-q4-a2' ],
								[ 'label' => 'reader-foundational-ce-q4-a3' ],
							]
						],
						[
							'name' => 'reader-foundational-ce-q5',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q5',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-age1' ],
								[ 'label' => 'reader-age2' ],
						...
						[
							'name' => 'reader-foundational-ce-q6',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q6',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-student-yes' ],
								[ 'label' => 'reader-student-no' ],
								[ 'label' => 'reader-student-dk' ],
								[ 'label' => 'reader-student-rf' ],
							],
							'dependsOn' => [
								[
									'question' => 'reader-foundational-ce-q5',
						...
						[
							'name' => 'reader-foundational-ce-q7a',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q7a',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-student-lvl1' ],
								[ 'label' => 'reader-student-lvl2' ],
								[ 'label' => 'reader-student-lvl3' ],
								[ 'label' => 'reader-student-lvl4' ],
								[ 'label' => 'reader-student-not' ],
								[ 'label' => 'reader-student-lvl-rf' ],
							],
							'dependsOn' => [
								[
									'question' => 'reader-foundational-ce-q6',
						...
						[
							'name' => 'reader-foundational-ce-q7b',
							'layout' => 'single-answer',
						...
						[
							'name' => 'reader-foundational-ce-q8',
							'layout' => 'single-answer',
							'question' => 'reader-foundational-ce-q8',
							'shuffleAnswersDisplay' => false,
							'answers' => [
								[ 'label' => 'reader-english-yes' ],
								[ 'label' => 'reader-english-no' ],
								[ 'label' => 'reader-english-rf' ],
							],
							'dependsOn' => [
								[
									'question' => 'reader-foundational-ce-q5',
						...
						[
							...
							'answers' => [
								...
								[ 'label' => 'reader-gender-woman' ],
								[ 'label' => 'reader-gender-trans' ],
								[ 'label' => 'reader-gender-nonbinary' ],
								[ 'label' => 'reader-gender-genderfluid' ],
								[ 'label' => 'reader-gender-other' ],
								[ 'label' => 'ext-quicksurveys-answer-i-prefer-not-to-say' ] // FIXME: For testing.
							],
							'dependsOn' => [
								[
									'question' => 'reader-foundational-ce-q5',
