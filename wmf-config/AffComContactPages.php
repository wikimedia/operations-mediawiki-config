...
$wgHooks['EmailUserForm'][] = function ( $form ) {
	if ( $form->getLegend( 'do-not-create-this-message' ) !== '<contactpage-affcomusergroup-do-not-create-this-message>' ) {
		return true;
	}

	$form->setWrapperLegendMsg( 'contactpage-affcom-user-group-form-title' );
