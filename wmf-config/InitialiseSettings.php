...
'wmgCirrusSearchUserTesting' => [
	// This does enable the triggers on wikis that don't have the rescore
	// profile, but since they are only triggers and not something enabled
	// by default that is reasonable.
	'default' => [
		'ltr' => [
			'globals' => [
