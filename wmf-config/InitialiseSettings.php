...
'wgLogo' => array(
	...
	'fawiki' => '//upload.wikimedia.org/wikipedia/commons/1/12/Wikipedia-logo-v2-fa.png',
	'ffwiki' => '$stdlogo',
...
'wgDebugLogGroups' => array(
	'default' => array(
		...
		'exception-json' => "udp://$wmgUdp2logDest/exception-json",
		...
		'JobQueueRedis' => "udp://$wmgUdp2logDest/redis-jobqueue",
		'es-hit' => "udp://$wmgUdp2logDest/es-hit",
		'poolcounter' => "udp://$wmgUdp2logDest/poolcounter",
		'lc-recache' => "udp://$wmgUdp2logDest/lc-recache",
		'generated-pp-node-count' => "udp://$wmgUdp2logDest/generated-pp-node-count",
		'api' => "udp://$wmgUdp2logDest/api",
		'SQLBagOStuff' => "udp://$wmgUdp2logDest/sql-bagostuff",

		'FileOperation' => "udp://$wmgUdp2logDest/filebackend-ops",
		'SwiftBackend' => "udp://$wmgUdp2logDest/swift-backend", // -aaron 5/15/12
		'updateTranstagOnNullRevisions' => "udp://$wmgUdp2logDest/updateTranstagOnNullRevisions",
		'redis' => "udp://$wmgUdp2logDest/redis", // -asher 2012/10/12
		'memcached-serious' => "udp://$wmgUdp2logDest/memcached-serious", // -aaron 2012/10/24
		'404' => "udp://$wmgUdp2logDest/four-oh-four",
		'resourceloader' => "udp://$wmgUdp2logDest/resourceloader",
		'wikibase' => "udp://$wmgUdp2logDest/wikibase",
		'oai' => "udp://$wmgUdp2logDest/oai",
		'captcha' => "udp://$wmgUdp2logDest/captcha",
		'ExternalStoreDB' => "udp://$wmgUdp2logDest/external",
		'query' => "udp://$wmgUdp2logDest/botquery",
		'antispoof' => "udp://$wmgUdp2logDest/antispoof",
		'badpass' => "udp://$wmgUdp2logDest/badpass",
		'ts_badpass' => "udp://$wmgUdp2logDest/ts_badpass",
		'EventLogging'  => "udp://$wmgUdp2logDest/eventlogging",
		'torblock'  => "udp://$wmgUdp2logDest/torblock",
		'mobile'  => "udp://$wmgUdp2logDest/mobile",
		'mwsearch' => "udp://$wmgUdp2logDest/mwsearch",
		'MessageCache' => "udp://$wmgUdp2logDest/messagecache",
		'temp-debug' => "udp://$wmgUdp2logDest/temp-debug", // generic admin debug log
		'CentralAuth' => "udp://$wmgUdp2logDest/centralauth", // -pgehres 2013/05/09, tmp for SUL finalization
		'GettingStarted' => "udp://$wmgUdp2logDest/gettingstarted",
		'zero' => "udp://$wmgUdp2logDest/zero", // zero-rated debug log
		'geodata' => "udp://$wmgUdp2logDest/geodata",
		'DBPerformance' => "udp://$wmgUdp2logDest/dbperformance",
		'CirrusSearch' => "udp://$wmgUdp2logDest/CirrusSearch",
		'wap' => "udp://$wmgUdp2logDest/wap",
		'texvc' => "udp://$wmgUdp2logDest/texvc",
		'Bug54847' => "udp://$wmgUdp2logDest/Bug54847",
		'recursion-guard' => "udp://$wmgUdp2logDest/recursion-guard",
		'MassMessage' => "udp://$wmgUdp2logDest/MassMessage", // for bug 57464 -legoktm 2013/12/15
	),

	'+enwiki' => array(
		'bug46577' => "udp://$wmgUdp2logDest/bug46577", // Education Program debugging
	),

	'+private' => array(
		'slow-parse' => "udp://$wmgUdp2logDest/privatewiki-slow-parse",
	),
