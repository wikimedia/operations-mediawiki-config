...
'wmgMonologAvroSchemas' => array(
	'api' => '{"type":"record","name":"ApiRequest","namespace":"org.wikimedia.mediawiki.api","doc":"","fields":[{"name":"wikiId","type":"string"},{"name":"method","type":"string"},{"name":"username","type":"string"},{"name":"ip","type":"string"},{"name":"userAgent","type":"string"},{"name":"requestMs","type":["null","int"]},{"name":"params","type":{"type":"map","values":"string"}}]}',
...
'wmgMonologChannels' => array(
	'default' => array(
		...
		'antispoof' => 'debug',
		'api' => array( 'kafka' => 'debug', 'logstash' => false, 'udp2log-formatter' => 'line-no-context' ),
