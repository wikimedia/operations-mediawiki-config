...
'wmgAutopromoteOnceonEdit' => [
	...
	'trwiki' => [
		'autoreview' => [
			...
			[ APCOND_AGE, 7 * 86400 ],
			[ APCOND_EDITCOUNT, 30 ],
			[ APCOND_FR_EDITSUMMARYCOUNT, 5 ],
			[ APCOND_FR_UNIQUEPAGECOUNT, 5 ],
			[ APCOND_FR_EDITSPACING, 7, 7 ],
			[ APCOND_FR_CONTENTEDITCOUNT, 20, 2 * 86400 ],
			[ APCOND_FR_NEVERBLOCKED ],
			[ APCOND_FR_MAXREVERTEDEDITRATIO, 0.03 ],
			[ '!', [ APCOND_INGROUPS, 'sysop' ] ],
			[ '!', [ APCOND_INGROUPS, 'bureaucrat' ] ],
			[ '!', [ APCOND_INGROUPS, 'bot' ] ],
		...
		'patroller' => [
			...
			[ APCOND_FR_EDITSUMMARYCOUNT, 25 ],
			[ APCOND_FR_UNIQUEPAGECOUNT, 10 ],
			[ APCOND_FR_EDITSPACING, 7, 15 ],
			[ APCOND_FR_CONTENTEDITCOUNT, 100, 1 * 86400 ],
			[ APCOND_FR_NEVERBLOCKED ],
			[ APCOND_FR_MAXREVERTEDEDITRATIO, 0.03 ],
			[ '!', [ APCOND_INGROUPS, 'sysop' ] ],
			[ '!', [ APCOND_INGROUPS, 'bureaucrat' ] ],
...
'wgGraphImgServiceUrl' => [
	...
	'afwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'huwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'ruwikinews' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'enwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'rowiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'ruwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'nowiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'urwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'plwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'jawiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'dewiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'frwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'itwiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'eswiki' => "/api/rest_v1/page/graph/png/%2\$s/0/%4\$s.png",
	'testwiki' => false,
...
'wgGEHelpPanelLinks' => [
	...
	'frwiki' => [
		[
			'title' => 'Wikipédia:Conventions de style',
			'text' => 'Conventions de style',
			'id' => 'style',
		],
		[
			'title' => 'Aide:Comment modifier une page',
			'text' => 'Comment modifier une page',
			'id' => 'editpage',
		],
		[
			'title' => 'Aide:Insérer une référence (Éditeur visuel)',
			'text' => 'Insérer une référence',
			'id' => 'citation',
		],
		[
			'title' => 'Aide:Insérer une image (Éditeur visuel)',
			'text' => 'Insérer une image',
			'id' => 'image',
		],
		[
			'title' => 'Aide:Comment créer un article',
			'text' => 'Comment créer un article',
			'id' => 'newarticle',
		],
	],
	'frwiktionary' => [
	...
	'hewiki' => [
		[
			'title' => 'ויקיפדיה:מדריך לעיצוב דפים',
			'text' => 'מדריך לעיצוב דפים',
			'id' => 'style',
		],
		[
			'title' => 'ויקיפדיה:אשף הערכים',
			'text' => 'אשף הערכים',
			'id' => 'articlewizard',
		],
		[
			'title' => 'mw:Help:VisualEditor/User_guide/he',
			'text' => 'העורך החזותי: מדריך למשתמש ',
			'id' => 'visualeditor',
		],
		[
