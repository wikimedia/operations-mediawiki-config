...
'wmgAutopromoteOnceonEdit' => array(
	...
	'trwiki' => array(
		'autoreview' => array(
			...
			array( APCOND_FR_EDITSUMMARYCOUNT, 5 ), /* requires FlaggedRevs */
			array( APCOND_FR_UNIQUEPAGECOUNT, 5 ), /* requires FlaggedRevs */
			array( APCOND_FR_EDITSPACING, 7, 7 ), /* requires FlaggedRevs */
			array( APCOND_FR_CONTENTEDITCOUNT, 20, 2*86400 ), /* requires FlaggedRevs */
			array( APCOND_FR_NEVERBOCKED ), /* requires FlaggedRevs */
			array( APCOND_FR_MAXREVERTEDEDITRATIO, .03 ), /* requires FlaggedRevs */
			array( '!', array( APCOND_INGROUPS, 'sysop' ) ),
			array( '!', array( APCOND_INGROUPS, 'bureaucrat' ) ),
		...
		'patroller' => array(
			...
			array( APCOND_FR_EDITSUMMARYCOUNT, 25 ), /* requires FlaggedRevs */
			array( APCOND_FR_UNIQUEPAGECOUNT, 10 ), /* requires FlaggedRevs */
			array( APCOND_FR_EDITSPACING, 7, 15 ), /* requires FlaggedRevs */
			array( APCOND_FR_CONTENTEDITCOUNT, 100, 1*86400 ), /* requires FlaggedRevs */
			array( APCOND_FR_NEVERBOCKED ), /* requires FlaggedRevs */
			array( APCOND_FR_MAXREVERTEDEDITRATIO, .03 ), /* requires FlaggedRevs */
			array( '!', array( APCOND_INGROUPS, 'sysop' ) ),
			array( '!', array( APCOND_INGROUPS, 'bureaucrat' ) ),
...
'wmgCirrusSearchShardCount' => array(
	...
	// very very common.
	'commonswiki' => array( 'content' => 1, 'general' => 10, 'file' => 7, 'titlesuggest' => 2 ),
