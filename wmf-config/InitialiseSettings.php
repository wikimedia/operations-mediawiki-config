...
# wmgCirrusSearchSanitizeProfile @{
# Classified according to max(page_id)-min(page_id) taken on Jul 5 2016
# XXL: more than 30M
# XL: more than 12M
# L: more than 1M
# M: more than 100K
...
# @} end of wgCirrusSearchSanitizeProfile
