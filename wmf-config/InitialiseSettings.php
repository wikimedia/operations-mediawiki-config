...
'wgLocaltimezone' => [
	...
	'zghwiktionary' => 'Africa/Casablanca', // T399785
...
'wgCanonicalServer' => [
	...
	'sysop_itwiki' => 'https://sysop-it.wikipedia.org',
...
'wmgMonologChannels' => [
	...
	'default' => [
		...
		'api-warning' => 'debug',
		'authentication' => 'info',
		'authevents' => [ 'udp2log' => false, 'logstash' => 'info', 'sample' => 1000 ],
		'badpass' => 'debug',
		'badpass-priv' => 'debug',
		'BlockManager' => 'info',
		'BounceHandler' => 'debug',
		...
		'session-sampled' => [ 'udp2log' => false, 'logstash' => 'info', 'sample' => 1000 ],
...
'wgWMCPrivilegedGroups' => [
	...
	'default' => [
		...
		'bureaucrat', 'checkuser', 'interface-admin', 'oauthadmin', 'temporary-account-viewer', 'suppress', 'sysop',
		...
		'abusefilter' /* enwiki */, 'curator' /* enwikiversity */, 'engineer' /* cswiki, ruwiki */, 'facilitator' /* frwikinews */, 'founder' /* enwiki */, 'templateeditor' /* rowiki */, 'test-sysop' /* betawikiversity, incubatorwiki */, 'translator' /* incubatorwiki */, 'wikidata-staff', 'wikifunctions-staff', 'vrt-agent', /* nlwiki */
...
'wgImportSources' => [
	...
	'shwiki' => [ 'ar', 'bs', 'de', 'en', 'es', 'fr', 'hr', 'id', 'ru', 'sr', 'zh', 'commons', 'incubator', 'meta' ], // T399113
...
'wgFavicon' => [
	...
	'arbcom_plwiki' => '/static/favicon/arbcom_plwiki.ico', // T406883
...
'wgNewUserMessageOnAutoCreate' => [
	'default' => false, // Replaced by wgNewUserMessageOnFirstEdit: T426206
],
...
'wgCiteSubReferencing' => [
	...
	// group1 wikis
	'group1' => true, // T425662
	'cawiki' => false, // T425662
	// Exclude all wikisource wikis in group1, see T425662
	'arwikisource' => false,
	'aswikisource' => false,
	'azwikisource' => false,
	'banwikisource' => false,
	...
	'zhwikisource' => false,
	// Exclude any remaining RTL wiki in group1, see T425662
	'arwikibooks' => false,
	'arwikiquote' => false,
	'arwikiversity' => false,
	'arwiktionary' => false,
...
'wgTranslateDisabledTargetLanguages' => [
	...
	'wikifunctionswiki' => [
		'*' => [
			...
			'ku' => 'This language code should remain unused. Localise in ku-latn please.',
...
'wgSpecialContributeSkinsEnabled' => [
	'specialcontribute' => [ "minerva", "vector-2022" ],
],

'wgSpecialContributeNewPageTarget' => [
	'default' => null,
	'afwiki' => "Wikipedia:Versoekte artikels",
	'alswiki' => "Wikipedia:Fehlende Artikel",
	'anpwiki' => "विकिपीडिया:अनुरोधित लेख",
	'arwiki' => "ويكيبيديا:مقالات مقترحة",
	'arywiki' => "ويكيپيديا:طلب لمصاوبة د صفحة",
	'arzwiki' => "ويكيبيديا:مقالات مقترحه",
	'aswiki' => "ৱিকিপিডিয়া:প্ৰবন্ধৰ অনুৰোধ",
	'astwiki' => "Wikipedia:Pidimientos",
	'avwiki' => "Википедия:ГӀуцӀиялъе",
	'azwiki' => "Vikipediya:Məqalə istəkləri",
	'bawiki' => "Википедия:Булдырыуға",
	'bewiki' => "Вікіпедыя:Што рабіць",
	'be_x_oldwiki' => "Вікіпэдыя:На стварэньне",
	'bewwiki' => "Wikipédi:Pepintaan makalah",
	'bgwiki' => "Уикипедия:Идеи за статии",
	'bnwiki' => "উইকিপিডিয়া:অনুরোধের খাতা",
	'brwiki' => "Wikipedia:Pajennoù goulennet",
	'bswiki' => "Wikipedia:Zatraženi članci",
	'cawiki' => "Viquipèdia:Articles demanats",
	'ckbwiki' => "ویکیپیدیا:داخوازی وتارێکی نوێ",
	'crhwiki' => "Vikipediya:Maqale talapları",
	'cswiki' => "Wikipedie:Požadované články",
	'cuwiki' => "Википєдїꙗ:Страницѧ къ сътворѥниѭ",
	'cywiki' => "Wicipedia:Erthyglau a geisir",
	...
	'euwiki' => "Wikipedia:Eskatutako artikuluak",
	'fawiki' => "ویکی‌پدیا:مقاله‌های درخواستی",
	'fiwiki' => "Wikipedia:Artikkelitoiveet",
	'frwiki' => "Wikipédia:Articles à créer",
	'fywiki' => "Wikipedy:Winske artikels",
	'gawiki' => "Vicipéid:Ailt iarrtha",
	'glwiki' => "Wikipedia:Artigos solicitados",
	'gnwiki' => "Vikipetã:Kuatiahairã jerure",
	'hawwiki' => "ʻO Wikipikia:Requested articles",
	'hewiki' => "ויקיפדיה:בקשת ערך",
	'hiwiki' => "विकिपीडिया:अनुरोधित लेख",
	'hrwiki' => "Wikipedija:Željeni članci",
	'huwiki' => "Wikipédia:Kért cikkek",
	'idwiki' => "Wikipedia:Permintaan artikel",
	'ilowiki' => "Wikipedia:Dagiti dawat nga artikulo",
	'iswiki' => "Wikipedia:Tillögur að greinum",
	'itwiki' => "Wikipedia:Voci richieste",
	'jawiki' => "Wikipedia:執筆依頼",
	'kawiki' => "ვიკიპედია:მოთხოვნილი სტატიები",
	'kcgwiki' => "Wukipedia:Articles for creation",
	'kkwiki' => "Уикипедия:Мақала сұранысы",
	'kmwiki' => "វិគីភីឌា:Most wanted articles",
	'knwiki' => "ವಿಕಿಪೀಡಿಯ:ಕೋರಿಕೆಯ ಲೇಖನಗಳು",
	'kowiki' => "위키백과:문서 작성 요청",
	'kswiki' => "وِکیٖپیٖڈیا:مَضموٗن عَرٕض",
	'ladwiki' => "Vikipedya:Artikolos demandados",
	'ltwiki' => "Vikipedija:Pageidaujami straipsniai",
	'lvwiki' => "Vikipēdija:Pieprasītie raksti",
	'mlwiki' => "വിക്കിപീഡിയ:ലേഖനങ്ങൾക്കുള്ള അപേക്ഷ",
	'mnwiki' => "Википедиа:Хэрэгцээт өгүүллүүд",
	'mswiki' => "Wikipedia:Memohon rencana",
	'mtwiki' => "Wikipedija:Artikli rikjesti",
	'ndswiki' => "Wikipedia:He'w neudig",
	'nlwiki' => "Wikipedia:Gewenste artikelen",
	'nnwiki' => "Wikipedia:Ynskjelista",
	'nowiki' => "Wikipedia:Ønskelisten",
	'ocwiki' => "Wikipèdia:Demandar un article",
	'orwiki' => "ଉଇକିପିଡ଼ିଆ:ଦରକାରୀ ପ୍ରସଙ୍ଗ ତାଲିକା",
	'plwiki' => "Wikipedia:Propozycje tematów",
	'pswiki' => "ويکيپېډيا:ليکنې لپاره درخواست",
	'ptwiki' => "Wikipédia:Artigos pedidos",
	'rowiki' => "Wikipedia:Articole cerute",
	'roa_tarawiki' => "Wikipedia:Pàggene ca avessera stà",
	'ruwiki' => "Википедия:К созданию",
	'ruewiki' => "Вікіпедія:Жаданы статї",
	'scowiki' => "Wikipedia:Requestit airticles",
	'sdwiki' => "وڪيپيڊيا:درخواست ڪيل مضمون",
	'sewiki' => "Wikipedia:Artihkalsávaldagat",
	'shwiki' => "Wikipedija:Zatraženi članci",
	'siwiki' => "විකිපීඩියා:Requested articles",
	'simplewiki' => "Wikipedia:Requested pages",
	'skwiki' => "Wikipédia:Žiadané články",
	'slwiki' => "Wikipedija:Želeni članki",
	'smnwiki' => "Wikipedia:Artikkâlvuávám",
	'sowiki' => "Wikipedia:Maqaalo la codsaday",
	'srwiki' => "Википедија:Потребни чланци",
	'suwiki' => "Wikipedia:Rekés artikel",
	'svwiki' => "Wikipedia:Önskelista",
	'swwiki' => "Wikipedia:Makala zilizoombwa",
	'szlwiki' => "Wikipedyjo:Propozycje tymatůw",
	'tawiki' => "விக்கிப்பீடியா:கோரப்படும் கட்டுரைகள்",
	'tgwiki' => "Википедиа:Мақолаҳои дархостӣ",
	'thwiki' => "วิกิพีเดีย:บทความที่ต้องการ",
	'tiwiki' => "ዊኪፐድያ:Requested pages",
	'tlwiki' => "Wikipedia:Mga hiniling na artikulo",
	'trwiki' => "Vikipedi:Madde istekleri",
	'ttwiki' => "Википедия:Yasıysı bitlär",
	'ukwiki' => "Вікіпедія:Запити на статті",
	'urwiki' => "ویکیپیڈیا:درخواست شدہ مضامین",
	'uzwiki' => "Vikipediya:Yaratishga",
	'vecwiki' => "Wikipedia:Voxe domandae",
	'viwiki' => "Wikipedia:Bài thỉnh cầu",
	'warwiki' => "Wikipedia:Ginpaalayon nga mga artikulo",
	'wuuwiki' => "Wikipedia:编写请求",
	'yiwiki' => "װיקיפּעדיע:בעטן ארטיקלען",
	'zghwiki' => "ⵡⵉⴽⵉⴱⵉⴷⵢⴰ:ⵜⴰⵙⵓⵎⵔⵜ ⴷ ⵓⵙⵓⵖⵍ ⵏ ⵉⵎⵏⵏⵉⵜⵏ",
	'zhwiki' => "Wikipedia:条目请求",
	'zh_min_nanwiki' => "Wikipedia:Teng-kiû bûn-chiuⁿ",
	'zh_yuewiki' => "Wikipedia:文章請"
],
...
'wgQuickSurveysConfig' => [
	...
	'enwiki' => [
		[
			// T428876
			// English Wikipedia Mobile App Survey — Wikipedia 25 app-awareness campaign.
			// Pre-deploy at coverage 0. Raise to 0.005 at go-live.
			// Logged-out, mobile web only.
			...
			'confirmMsg' => 'mobile-app-awareness-2026-en-survey-confirm-msg',
			'confirmDescription' => 'mobile-app-awareness-2026-en-survey-confirm-description',
			'questions' => [
				// Q00 — Intro + consent gate (ask all); the rest of the survey depends on "Yes"
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q00',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q00',
					'description' => 'mobile-app-awareness-2026-en-survey-intro',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-yes' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-no' ],
					],
				],
				// Q01 — Age (ask all)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q01',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q01',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a5' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a6' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q01-a7' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-prefer-not-to-say' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q00',
							'answerIsOneOf' => [
								'mobile-app-awareness-2026-en-survey-yes',
							]
						]
					],
				],
				// Q02 — Student enrollment (ask all)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q02',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q02',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-yes' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-no' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-not-sure' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-prefer-not-to-say' ],
					],
					'dependsOn' => [
						[
				...
				// Q03 — Highest level of education (ask all)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q03',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q03',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q03-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q03-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q03-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q03-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q03-a5' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-not-sure' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-prefer-not-to-say' ],
					],
					'dependsOn' => [
				...
				// Q04 — Wikipedia reading frequency, past 30 days (ask all)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q04',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q04',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q04-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q04-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q04-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q04-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q04-a5' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-not-sure' ],
					],
					'dependsOn' => [
						[
				...
				// Q05 — How they usually access Wikipedia on mobile (ask all)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q05',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q05',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q05-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q05-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q05-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q05-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q05-a5' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q00',
				...
				// Q06 — What an app should do better (ask all, randomize, select up to 3)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q06',
					...
					'answers' => [
						...
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a5' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a6' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a7' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a8' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a9' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a10' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q06-a11' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q00',
				...
				// Q07 — Experience with the Wikipedia mobile app (ask all, branch point)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q07',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q07',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a5' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q07-a6' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-not-sure' ],
					],
					'dependsOn' => [
						[
				...
				// Q08 — How they first heard about the app (PATH A: app-aware, randomize)
				[
					...
					'answers' => [
						...
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q08-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q08-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q08-a5' ],
						[
							'label' => 'mobile-app-awareness-2026-en-survey-q08-a6',
							'freeformTextLabel' => 'mobile-app-awareness-2026-en-survey-please-specify'
						],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q08-a7' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q07',
							'answerIsOneOf' => [
								'mobile-app-awareness-2026-en-survey-q07-a2',
								'mobile-app-awareness-2026-en-survey-q07-a3',
								'mobile-app-awareness-2026-en-survey-q07-a4',
								'mobile-app-awareness-2026-en-survey-q07-a5',
								'mobile-app-awareness-2026-en-survey-q07-a6',
							]
						]
					],
				],
				// Q09 — What stopped them downloading/using (PATH C: lapsed, randomize, up to 2)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q09',
					'layout' => 'multiple-answer',
					...
					'answers' => [
						...
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q09-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q09-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q09-a5' ],
						[
							'label' => 'mobile-app-awareness-2026-en-survey-q09-a6',
							'freeformTextLabel' => 'mobile-app-awareness-2026-en-survey-please-specify'
						],
					],
					'dependsOn' => [
				...
				// Q10 — Interest in learning more (PATH B: non app-aware, 5-point scale)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q10',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q10',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q10-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q10-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q10-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q10-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q10-a5' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q07',
							'answerIsOneOf' => [
								'mobile-app-awareness-2026-en-survey-q07-a1',
								'mobile-app-awareness-2026-en-survey-not-sure',
							]
						]
					],
				],
				// Q11 — Likelihood to download in next 30 days (PATH B + PATH C, 5-point scale)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q11',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q11',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q11-a1' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q11-a2' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q11-a3' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q11-a4' ],
						[ 'label' => 'mobile-app-awareness-2026-en-survey-q11-a5' ],
					],
					'dependsOn' => [
						[
							'question' => 'mobile-app-awareness-2026-en-survey-q07',
				...
				// Q12 — One thing they want in the app (ask all, open text)
				[
					'name' => 'mobile-app-awareness-2026-en-survey-q12',
					'layout' => 'single-answer',
					'question' => 'mobile-app-awareness-2026-en-survey-q12',
					'shuffleAnswersDisplay' => false,
					'answers' => [
						[
							'label' => 'mobile-app-awareness-2026-en-survey-q12-a1',
							'freeformTextLabel' => 'mobile-app-awareness-2026-en-survey-q12-a1-placeholder'
						],
					],
					'dependsOn' => [
						[
...
'wmgWikibaseTmpWikiProjectsLinking' => [
	'wikidatawiki' => [
		...
		[
			...
			'href' => 'https://www.wikidata.org/wiki/Special:MyLanguage/Wikidata:WikiProject_Medicine',
			'msg' => 'wikiprojects-sidebar-wikiproject-medicine',
		],
		[
			# WikiProject Datasets (T422935)
			'propertyIds' => [
				'P1325',
				'P2666',
				'P2702',
			...
			'href' => 'https://www.wikidata.org/wiki/Special:MyLanguage/Wikidata:WikiProject_Datasets',
			'msg' => 'wikiprojects-sidebar-wikiproject-datasets',
		],
		[
