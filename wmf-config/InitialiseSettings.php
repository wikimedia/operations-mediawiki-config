...
global $wmgUdp2logDest, $wmgDatacenter, $wmgRealm, $wmgConfigDir, $wgConf,
	$wmgAllServices, $wmgLocalServices, $wmgMasterServices, $wmgMasterDatacenter;
...
'wmgLogstashServers' => [
	'default' => $wmgLocalServices['logstash'],
],

# wmgKafkaServers @{
// Kafka servers. Use false to disable all kafka logging.
'wmgKafkaServers' => [
	'default' => $wmgLocalServices['kafka'],
],
...
'wgCopyUploadProxy' => [
	'default' => $wmgLocalServices['urldownloader'],
],
'wgAllowCopyUploads' => [
	'default' => false,
	'testwiki' => true,
...
'wgRestbaseServer' => [
	'default' => $wmgLocalServices['restbase']
],
...
'wgStructuredChangeFiltersShowPreference' => [
	'default' => true,
	// Disabled on FlaggedRevs wikis with $wgFlaggedRevsProtection set to false in flaggedrevs.php (T177445)
],
...
'wgUploadThumbnailRenderHttpCustomDomain' => [
	'default' => $wmgLocalServices['upload'],
],
