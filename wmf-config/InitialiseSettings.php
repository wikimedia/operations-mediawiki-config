...
'wgMetaNamespaceTalk' => [
	...
	'aswikisource' => 'ৱিকিউ_স_বাৰ্তা', // T45129
...
'wgRestrictionLevels' => [
	...
	'srwiki' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
	'srwikibooks' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
	'srwikinews' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
	'srwikisource' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
	'srwikiquote' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
	'srwiktionary' => [ '', 'autoconfirmed', 'autopatrol', 'patrol', 'rollback', 'bot', 'sysop', 'bureaucrat' ], // T215653
...
'wmgMonologChannels' => [
	'default' => [
		...
		'OAuth' => 'debug',
		'OutputBuffer' => 'debug',
		'PageTriage' => 'warning', // sbisson - T202815
		'PageViewInfo' => 'info',
		'poolcounter' => 'debug',
		'preferences' => 'info',
		'purge' => 'debug',
...
'wgAccountCreationThrottle' => [
	'default' => 4, // previously 10. Temp to 4 on Dec 29 T212667
	'mediawikiwiki' => [ 'count' => 2, 'seconds' => 60 * 60 * 72 ], // temp T212667
	'kowiki' => [ 'count' => 2, 'seconds' => 60 * 60 * 72 ], // temp T212667
...
'wmgWikibaseClientPageSchemaSplitTestSamplingRatio' => [
	// 100% of pages will be sampled. Half of those (.5) will receive the new treatment.
	'default' => 1,
