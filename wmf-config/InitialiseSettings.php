...
'move-rootuserpages' => true, 'undelete' => true, 'rollback' => true, 'delete' => true, 'deleterevision' => true, 'reupload' => true
	...
	'metawiki' => array(
		...
		'flood' => array( 'bot' => true ),
		'autopatrolled' => array( 'autopatrol' => true ),
		'CentralNotice' => array( 'centralnotice-admin' => true, 'editinterface' => true ), //adding to allow CN access without local sysop JRA 2013-02-21
	),
	'mkwiki' => array(
		'autopatrolled' => array( 'autopatrol' => true ),
		'patroller' => array( 'patrol' => true, 'autopatrol' => true, 'rollback' => true ),
...
'wgRemoveGroups' => array(
	...
	'+testwiki' => array(
		'bureaucrat' => array( 'sysop', 'researcher', 'translationadmin', 'CentralNotice' ),
		'sysop' => array( 'filemover', 'rollbacker', 'accountcreator', 'confirmed' ),
		# 'user' => array( 'editor', 'reviewer' ),
	),
	// ******************************************************************
	...
	'+metawiki' => array(
		'bureaucrat' => array( 'sysop', 'bureaucrat', 'ipblock-exempt', 'flood', 'translationadmin', 'CentralNotice' ), // https://bugzilla.wikimedia.org/show_bug.cgi?id=37198
		'checkuser'  => array( 'ipblock-exempt' ),
		'sysop'      => array( 'autopatrolled' ),
	),
	'+mkwiki' => array(
