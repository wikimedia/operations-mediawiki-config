...
'wgAddGroups' => [
	...
	'+zhwiki' => [
		'bureaucrat' => [ 'flood' ],
		'sysop' => [ 'patroller', 'rollbacker', 'autoreviewer', 'confirmed', 'massmessage-sender', 'movefile' ], // T130814 and T195247
	],
	'+zhwikibooks' => [
		'sysop' => [ 'flood' ], // T185182
	],
...
'wgRemoveGroups' => [
	...
	'+zhwiki' => [
		'bureaucrat' => [ 'flood' ],
		'sysop' => [ 'patroller', 'rollbacker', 'autoreviewer', 'confirmed', 'flood', 'massmessage-sender', 'movefile' ], // T130814 and T195247
		'filemover' => [ 'movefile' ], // T195247
	],
	'+zhwikibooks' => [
		'sysop' => [ 'flood' ], // T185182
	],
...
'wmgWikibaseIdBlacklist' => [
	'default' => [
		'wikibase-lexeme' => [
			1, 5, 8, 18, 42, 55, 99, 117, 123, 221, 314, 666, 777, 1887, 12345, 24601
		],
	],
],
