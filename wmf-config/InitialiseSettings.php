...
'wgRelatedArticlesABTestEnrollment' => [
	'default' => [
		...
		"buckets" => [
			...
			"experimentEnabled" => 0.005,
			"experimentDisabled" => 0.005
		],
	],
	'euwiki' => [
