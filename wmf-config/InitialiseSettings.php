...
'wmgMonologChannels' => [
	'default' => [
		...
		'WMDE' => 'debug', // addshore 12/04/2017, to be removed after 22/04/2017
		'xenon' => 'debug',
		'XMP' => 'warning', // T89532
		'xff' => [ 'logstash' => false ],
...
'wgRemoveGroups' => [
	...
	'+arwiki' => [
		'bureaucrat' => [ 'import', 'reviewer', 'abusefilter', 'accountcreator','epcoordinator','epcampus','eponline','epinstructor', ], // T143844 // T163511
		'sysop' => [ 'uploader', 'reviewer', 'confirmed', 'rollbacker', 'abusefilter', 'patroller', 'autopatrolled','epcoordinator','epcampus','eponline','epinstructor', ], // T163511
	],
	'+arwikisource' => [
		'sysop' => [ 'patroller', 'autopatrolled', 'rollbacker' ],
	],
...
'wmgUseGettingStarted' => [
	...
	'cawiki' => true,
	'dawiki' => true,
	// 'dewiki' => true, // addshore 12/04/2017, could be re-enabled after 22/04/2017
	'elwiki' => true,
	'enwiki' => true,
	'eswiki' => true,
	'fawiki' => true,
