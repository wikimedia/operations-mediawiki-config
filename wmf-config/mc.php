...
[ $wfMCHost, $wfMCPort ] = explode( ':', $_SERVER['MCROUTER_SERVER'] ?? '127.0.0.1:11213' );
$eqiadDCWFMC = [ 'eqiad' => [ 'host' => $wfMCHost, 'port' => $wfMCPort, 'prefix' => '/eqiad/wf-wan/' ] ];
$codfwDCWFMC = [ 'codfw' => [ 'host' => $wfMCHost, 'port' => $wfMCPort, 'prefix' => '/codfw/wf-wan/' ] ];
