...
$wgLucenePrefixHost = $wmfLucenePrefixVips[abs( crc32( $wgDBname ) ) % count( $wmfLucenePrefixVips )];
...
$wgLuceneHost = $wmfLuceneHostVips[abs( crc32( $wgDBname ) ) % count( $wmfLuceneHostVips )];
