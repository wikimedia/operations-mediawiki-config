...
function wmfExcimerFlushCallback( $log, $options ) {
	...
	try {
		...
		// The first frame should be the entry point that started the PHP process.
		// In most cases, this happens by default already. But at least for for destructor
		// callbacks, this isn't the case on PHP 7. E.g. a line may be:
