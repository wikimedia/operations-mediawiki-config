...
return [
	'alphabetic' => [ // by language name, e.g. 'id' as 'Indonesia, bahasa'
		...
		'sm', 'sa', 'sg', 'sat', 'skr', 'sc', 'sco', 'trv', 'stq', 'st', 'nso', 'tn', 'sq', 'scn',
	...
	'alphabetic_revised' => [ // by first word, e.g. 'id' as 'bahasa Indonesia'
		...
		'sa', 'sg', 'sat', 'skr', 'sc', 'sco', 'trv', 'stq', 'st', 'nso', 'tn', 'sq', 'scn', 'si',
		'simple', 'sd', 'ss', 'sk', 'sl', 'cu', 'szl', 'so', 'ckb', 'srn', 'sr', 'sh', 'su',
		'fi', 'sv', 'shy', 'tl', 'ta', 'shi', 'kab', 'roa-tara', 'tt', 'tay', 'te', 'tet', 'din', 'th', 'vi',
	...
	'alphabetic_sr' => [ // by first word, non-Cyrillic/non-Roman/non-Greek name by language code
		...
		'rm', 'qu', 'rue', 'ru', 'sa', 'sah', 'szy', 'sat', 'sg', 'sc', 'sco', 'trv', 'sd', 'stq',
		'st', 'nso', 'tn', 'sq', 'si', 'scn', 'simple', 'ss', 'skr', 'sk', 'sl', 'cu', 'szl',
	...
	'alphabetic_fy' => [ // by language code, exepct 'y' is sorted like 'i'
		...
		'lmo', 'ln', 'lo', 'lrc', 'lt', 'ltg', 'lv', 'mad', 'mai', 'map-bms', 'mdf', 'mg', 'mh',
		'mhr', 'mi', 'my', 'min', 'myv', 'mk', 'ml', 'mn', 'mni', 'mnw', 'mo', 'mr', 'mrj', 'ms', 'mt',
		'mus', 'mwl', 'mzn', 'na', 'nah', 'nan', 'nap', 'nds', 'nds-nl', 'ne', 'new', 'ng',
		'ny', 'nia', 'nl', 'nn', 'no', 'nov', 'nqo', 'nrm', 'nso', 'nv', 'oc', 'olo', 'om', 'or', 'os', 'pa',
	...
	'alphabetic_svwiktionary' => [ // by first word, Roman letters first
		...
		'la', 'lv', 'lb', 'nia', 'lt', 'li', 'ln', 'jbo', 'hu', 'mg', 'mi', 'mo',
