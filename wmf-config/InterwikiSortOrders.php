...
return [
	'alphabetic' => [ // by language name, e.g. 'id' as 'Indonesia, bahasa'
		'ace', 'kbd', 'ady', 'af', 'ak', 'als', 'am', 'ang', 'ab', 'ar', 'an', 'arc', 'hyw',
		...
		'ht', 'gcr', 'ku', 'kj', 'ky', 'mrj', 'lad', 'lbe', 'lo', 'lrc', 'ltg', 'la',
		...
		'sh', 'su', 'fi', 'sv', 'tl', 'ta', 'shi', 'kab', 'roa-tara', 'tt', 'shn', 'te', 'tet',
	...
	'alphabetic_revised' => [ // by first word, e.g. 'id' as 'bahasa Indonesia'
		'ace', 'ady', 'kbd', 'af', 'ak', 'als', 'am', 'ang', 'ab', 'ar', 'an', 'arc', 'hyw', 'roa-rup',
		'frp', 'as', 'ast', 'atj', 'gn', 'av', 'ay', 'az', 'azb', 'gor', 'id', 'ms', 'ban',
		...
		'ks', 'csb', 'kk', 'kw', 'rw', 'ky', 'rn', 'mrj', 'sw', 'kv', 'kg', 'ht', 'gcr', 'ku',
		'kj', 'lad', 'lbe', 'lo', 'la', 'lrc', 'ltg', 'lv', 'to', 'lb', 'lez', 'lt', 'lij',
	...
	'alphabetic_sr' => [ // by first word, non-Cyrillic/non-Roman name by language code
		...
		'roa-rup', 'frp', 'arz', 'as', 'ast', 'atj', 'gn', 'av', 'ay', 'az', 'azb', 'gor',
		...
		'kg', 'ht', 'gcr', 'ks', 'ku', 'kj', 'lad', 'lbe', 'la', 'lrc', 'ltg', 'lv', 'to',
		...
		'so', 'ckb', 'srn', 'sr', 'sh', 'shn', 'su', 'fi', 'sv', 'ta', 'shi', 'tl', 'kab',
	...
	'alphabetic_fy' => [ // by language code, exepct 'y' is sorted like 'i'
		...
		'ks', 'ksh', 'ku', 'kv', 'kw', 'la', 'lad', 'lb', 'lbe', 'lez', 'lfn', 'lg', 'li', 'lij',
		...
		'rw', 'sa', 'sah', 'sat', 'sc', 'scn', 'sco', 'sd', 'se', 'sg', 'sh', 'shi', 'shn', 'si', 'simple',
	...
	'alphabetic_svwiktionary' => [ // by first word, Roman letters first
		...
		'tl', 'tt', 'vi', 'tpi', 'tr', 'tw', 'din', 'vo', 'wa', 'wo', 'ts', 'yo',
