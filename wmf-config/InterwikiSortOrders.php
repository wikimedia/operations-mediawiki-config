...
return [
	'alphabetic' => [ // by language name, e.g. 'id' as 'Indonesia, bahasa'
		'ace', 'kbd', 'ady', 'af', 'ak', 'als', 'am', 'smn', 'ang', 'ab', 'ar', 'an', 'arc', 'hyw',
		...
		'cbk-zam', 'ny', 'sn', 'tum', 'cho', 'co', 'cy', 'da', 'dk', 'ary', 'se', 'pdc', 'de',
		'dv', 'nv', 'dsb', 'dty', 'dz', 'mh', 'et', 'el', 'eml', 'en', 'myv', 'es', 'eo',
		'ext', 'eu', 'ee', 'fa', 'hif', 'fo', 'fr', 'fy', 'ff', 'fur', 'ga', 'gv',
		'gag', 'gd', 'gl', 'inh', 'gan', 'ki', 'glk', 'gu', 'got', 'gom', 'hak', 'xal', 'ko',
		...
		'lv', 'lb', 'lez', 'lt', 'lij', 'li', 'ln', 'lfn', 'olo', 'jbo', 'lg', 'lmo', 'hu', 'mai', 'mk',
		'mg', 'ml', 'mt', 'mi', 'mr', 'xmf', 'arz', 'mnw', 'mzn', 'ms', 'min', 'cdo', 'mwl',
		...
		'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'rue', 'ru', 'sah', 'szy',
		'sm', 'sa', 'sg', 'sat', 'sc', 'sco', 'stq', 'st', 'nso', 'tn', 'sq', 'scn',
		'si', 'simple', 'sd', 'ss', 'sk', 'sl', 'cu', 'szl', 'so', 'ckb', 'srn', 'sr',
		'sh', 'su', 'fi', 'sv', 'shy', 'tl', 'ta', 'shi', 'kab', 'roa-tara', 'tt', 'shn', 'te', 'tet',
	...
	'alphabetic_revised' => [ // by first word, e.g. 'id' as 'bahasa Indonesia'
		'ace', 'ady', 'kbd', 'af', 'ak', 'als', 'am', 'smn', 'ang', 'ab', 'ar', 'an', 'arc', 'hyw', 'roa-rup',
		'frp', 'as', 'ast', 'atj', 'awa', 'gn', 'av', 'ay', 'az', 'azb', 'gor', 'id', 'ms', 'ban',
		'bm', 'bn', 'bjn', 'zh-min-nan', 'nan', 'map-bms', 'ba', 'be', 'be-x-old', 'bh',
		'bcl', 'bi', 'bar', 'bo', 'bs', 'br', 'bug', 'bg', 'bxr', 'ca', 'ceb', 'cv', 'cs',
		'ch', 'cbk-zam', 'ny', 'sn', 'tum', 'cho', 'co', 'cy', 'da', 'dk', 'ary', 'se', 'pdc', 'de',
		...
		'kj', 'lld', 'lad', 'lbe', 'lo', 'la', 'lrc', 'ltg', 'lv', 'to', 'lb', 'lez', 'lt', 'lij',
		'li', 'ln', 'lfn', 'olo', 'jbo', 'lg', 'lmo', 'hu', 'mai', 'mk', 'mg', 'ml', 'mt',
		'mi', 'mr', 'xmf', 'arz', 'mzn', 'min', 'cdo', 'mwl', 'mdf', 'mo', 'mn', 'mus', 'my',
		'nah', 'fj', 'nl',  'nds-nl', 'cr', 'ne', 'new', 'ja', 'nap', 'nqo', 'ce', 'frr', 'pih', 'no',
		'nb', 'nn', 'nrm', 'nov', 'ii', 'oc', 'mhr', 'or', 'om', 'ng', 'hz', 'uz', 'pa', 'pi',
		'pfl', 'pag', 'pnb', 'pap', 'ps', 'jam', 'koi', 'km', 'shn', 'mnw', 'pcd', 'pms', 'nds', 'pl', 'pnt',
		'pt', 'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'rue', 'ru', 'sah', 'szy',
		'sa', 'sg', 'sat', 'sc', 'sco', 'stq', 'st', 'nso', 'tn', 'sq', 'scn', 'si',
		'simple', 'sd', 'ss', 'sk', 'sl', 'cu', 'szl', 'so', 'ckb', 'srn', 'sr', 'sh', 'su',
		'fi', 'sv', 'shy', 'tl', 'ta', 'shi', 'kab', 'roa-tara', 'tt', 'te', 'tet', 'din', 'th', 'vi',
	...
	'alphabetic_sr' => [ // by first word, non-Cyrillic/non-Roman name by language code
		'ace', 'ady', 'kbd', 'af', 'ak', 'als', 'am', 'smn', 'ang', 'ab', 'ar', 'an', 'arc',
		...
		'cy', 'cv', 'cs', 'da', 'dk', 'se', 'pdc', 'de', 'nv', 'dsb', 'na', 'dty', 'dv', 'dz',
		...
		'ik', 'os', 'xh', 'zu', 'is', 'it', 'ja', 'jv', 'kbp', 'ka', 'kl', 'kr', 'pam', 'krc',
		'csb', 'kk', 'kw', 'rw', 'ky', 'mrj', 'rn', 'sw', 'km', 'kn', 'ko', 'kv',
		'kg', 'avk', 'ht', 'gcr', 'ks', 'ku', 'kj', 'lld', 'lad', 'lbe', 'la', 'lrc', 'ltg', 'lv', 'to',
		'lb', 'lez', 'lt', 'lij', 'li', 'ln', 'lfn', 'olo', 'lo', 'jbo', 'lg', 'lmo', 'hu', 'mai',
		'mk', 'mg', 'mt', 'mi', 'min', 'cdo', 'mwl', 'ml', 'mdf', 'mo', 'mn', 'mnw', 'mr', 'mus',
		...
		'rm', 'qu', 'rue', 'ru', 'sa', 'sah', 'szy', 'sat', 'sg', 'sc', 'sco', 'sd', 'stq',
	...
	'alphabetic_fy' => [ // by language code, exepct 'y' is sorted like 'i'
		...
		'co', 'cr', 'crh', 'cs', 'csb', 'cu', 'cv', 'da', 'de', 'din', 'diq', 'dk', 'dsb', 'dty', 'dv',
		'dz', 'ee', 'el', 'eml', 'en', 'eo', 'es', 'et', 'eu', 'ext', 'fa', 'ff', 'fi',
		'fy', 'fiu-vro', 'fj', 'fo', 'fr', 'frp', 'frr', 'fur', 'ga', 'gag', 'gan', 'gcr', 'gd',
		'gl', 'glk', 'gn', 'gor', 'got', 'gom', 'gu', 'gv', 'ha', 'hak', 'haw', 'he', 'hi', 'hy',
		'hyw', 'hif', 'ho', 'hr', 'hsb', 'ht', 'hu', 'hz', 'ia', 'id', 'ie', 'ig', 'ii', 'yi',
		'ik', 'ilo', 'io', 'yo', 'inh', 'is', 'it', 'iu', 'ja', 'jam', 'jbo', 'jv', 'ka', 'kaa', 'kab',
		'kbd', 'kbp', 'kg', 'ki', 'ky', 'kj', 'kk', 'kl', 'km', 'kn', 'ko', 'koi', 'kr', 'krc',
		'ks', 'ksh', 'ku', 'kv', 'kw', 'la', 'lld', 'lad', 'lb', 'lbe', 'lez', 'lfn', 'lg', 'li', 'lij',
		'lmo', 'ln', 'lo', 'lrc', 'lt', 'ltg', 'lv', 'mai', 'map-bms', 'mdf', 'mg', 'mh',
		'mhr', 'mi', 'my', 'min', 'myv', 'mk', 'ml', 'mn', 'mnw', 'mo', 'mr', 'mrj', 'ms', 'mt',
		'mus', 'mwl', 'mzn', 'na', 'nah', 'nan', 'nap', 'nds', 'nds-nl', 'ne', 'new', 'ng',
		'ny', 'nl', 'nn', 'no', 'nov', 'nqo', 'nrm', 'nso', 'nv', 'oc', 'olo', 'om', 'or', 'os', 'pa',
		'pag', 'pam', 'pap', 'pcd', 'pdc', 'pfl', 'pi', 'pih', 'pl', 'pms', 'pnb', 'pnt',
		'ps', 'pt', 'qu', 'rm', 'rmy', 'rn', 'ro', 'roa-rup', 'roa-tara', 'ru', 'rue',
		'rw', 'sa', 'sah', 'sat', 'sc', 'scn', 'sco', 'sd', 'se', 'sg', 'sh', 'shi', 'shy', 'shn', 'si', 'simple',
		'sk', 'sl', 'sm', 'smn', 'sn', 'so', 'sq', 'sr', 'srn', 'ss', 'st', 'stq', 'su', 'sv',
		'sw', 'szl', 'szy', 'ta', 'tcy', 'te', 'tet', 'tg', 'th', 'ti', 'ty', 'tk', 'tl', 'tn', 'to',
	...
	'alphabetic_svwiktionary' => [ // by first word, Roman letters first
		...
		'shy', 'tl', 'tt', 'vi', 'tpi', 'tr', 'tw', 'din', 'vo', 'wa', 'wo', 'ts', 'yo',
