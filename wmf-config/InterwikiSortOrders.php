...
return [
	'alphabetic' => [
		...
		'ha', 'haw', 'hy', 'hyw', 'hi', 'ho', 'hsb', 'hr', 'gor', 'io', 'ig', 'ilo', 'bpy', 'id', 'ia',
		'ie', 'iu', 'ik', 'os', 'xh', 'zu', 'is', 'it', 'he', 'jv', 'kbp', 'kl', 'kn', 'kr',
		'pam', 'krc', 'ka', 'ks', 'csb', 'kk', 'kw', 'rw', 'rn', 'sw', 'kv', 'kg',
		'ht', 'ku', 'kj', 'ky', 'mrj', 'lad', 'lbe', 'lo', 'lrc', 'ltg', 'la',
		...
		'new', 'ja', 'nap', 'ce', 'frr', 'pih', 'no', 'nb', 'nn', 'nqo', 'nrm', 'nov', 'ii', 'oc',
		'mhr', 'or', 'om', 'ng', 'hz', 'uz', 'pa', 'pi', 'pfl', 'pag', 'pnb', 'pap', 'ps',
		'jam', 'koi', 'km', 'pcd', 'pms', 'tpi', 'nds', 'pl', 'tokipona', 'tp', 'pnt', 'pt',
		'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'rue', 'ru', 'sah', 'sat',
		'sm', 'sa', 'sg', 'sc', 'sco', 'stq', 'st', 'nso', 'tn', 'sq', 'scn',
	...
	'alphabetic_revised' => [
		...
		'gag', 'gd', 'gl', 'inh', 'gan', 'ki', 'glk', 'gu', 'got', 'gom', 'hak', 'xal', 'ko',
		'ha', 'haw', 'hy', 'hyw', 'hi', 'ho', 'hsb', 'hr', 'io', 'ig', 'ilo', 'bpy', 'ia', 'ie',
		'iu', 'ik', 'os', 'xh', 'zu', 'is', 'it', 'he', 'kbp', 'kl', 'kn', 'kr', 'pam', 'krc', 'ka',
		...
		'mi', 'mr', 'xmf', 'arz', 'mzn', 'cdo', 'mwl', 'mdf', 'mo', 'mn', 'mus', 'my',
		'nah', 'fj', 'nl',  'nds-nl', 'cr', 'ne', 'new', 'ja', 'nap', 'ce', 'frr', 'pih', 'no',
		'nb', 'nn', 'nqo', 'nrm', 'nov', 'ii', 'oc', 'mhr', 'or', 'om', 'ng', 'hz', 'uz', 'pa',
		'pi', 'pfl', 'pag', 'pnb', 'pap', 'ps', 'jam', 'koi', 'km', 'pcd', 'pms', 'nds', 'pl', 'pnt',
		'pt', 'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'ru', 'rue', 'sah', 'sat',
		'sa', 'sg', 'sc', 'sco', 'stq', 'st', 'nso', 'tn', 'sq', 'scn', 'si',
	...
	'alphabetic_sr' => [
		...
		'rm', 'qu', 'ru', 'rue', 'sa', 'sah', 'sat', 'sg', 'sc', 'sco', 'sd', 'stq',
		'st', 'nso', 'tn', 'sq', 'si', 'scn', 'simple', 'ss', 'sk', 'sl', 'cu', 'szl',
		'so', 'ckb', 'srn', 'sr', 'sh', 'shn', 'fi', 'sv', 'ta', 'shi', 'tl', 'kab',
	...
	'alphabetic_fy' => [
		...
		'rw', 'sa', 'sah', 'sat', 'sc', 'scn', 'sco', 'sd', 'sg', 'sh', 'shi', 'shn', 'si', 'simple',
	...
	'alphabetic_svwiktionary' => [
		...
		'sq', 'scn', 'simple', 'ss', 'sk', 'sl', 'so', 'sh', 'shn', 'fi', 'sv',
