...
if ( in_array( 'codfw', $datacenters ) ) {
	...
	$sharedMultiwriteFileBackend['backends'][] = [ 'template' => 'local-swift-codfw' ];
	$globalMultiWriteFileBackend['backends'][] = [ 'template' => 'local-swift-codfw' ];
	$sharedTestwikiMultiWriteFileBackend['backends'][] = [ 'template' => 'local-swift-codfw' ];
}
