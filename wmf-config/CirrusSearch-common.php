...
// Enable cache warming for wikis with more then one shard.  Cache warming is good
// for smoothing out io spikes caused by merges at the cost of potentially polluting
// the cache by adding things that won't be used.  Wikis with more then one shard
// is a decent way of saying "wikis we expect will get some search traffic every few
// seconds".  In this commonet the term "cache" refers to all kinds of caches: the
// linux disk cache, Elasticsearch's filter cache, whatever.
