...
'sectionLoads' => [
	's1' => [
		...
		# 'db1083' => 500,    # B1 3.6TB 512GB # future candidate master T197069#4418823 # net maint
		'db1089' => 300,    # C3 3.6TB 512GB # temporary candidate master T197069#4418823
		# 'db1099:3311' => 1, # B2 3.6TB 512GB # rc, log: s1 and s8 # net maint
		'db1105:3311' => 100, # C3 3.6TB 512GB # rc, log: s1 and s2
		'db1106' => 150,     # D3 3.6TB 512GB, vslow, dump # master for sanitarium db1124
		'db1114' => 200,    # D4 3.6TB 512GB, api
		# 'db1119' => 200,    # B8 3.6TB 512GB, api # net maint
	],
	's2' => [
		'db1066' => 0,     # A6 2.8TB 160GB # master
		'db1074' => 300,    # A2 3.6TB 512GB, api # master for sanitarium db1125
		# 'db1076' => 500,    # B1 3.6TB 512GB # candidate master # net maint
	...
	/* s3 */ 'DEFAULT' => [
		...
		# 'db1077' => 400,    # B1 3.6TB 512GB, rc, log # master for sanitarium db1124 # net maint
	...
	's4' => [
		...
		# 'db1084' => 300,    # B1 3.6TB 512GB, api # net maint
	...
	's5' => [
		...
		'db1100' => 50,     # C2 3.6TB 512GB, old master #api # candidate master # temporary vslow
		'db1110' => 500,    # C3 3.6TB 512GB
		# 'db1113:3315' => 1, # B8 3.6TB 512GB # vslow, dump: s5 and s6 # net maint
	],
	's6' => [
		'db1061' => 0,      # C3 2.8TB 128GB, master
		# 'db1085' => 300,    # B3 3.6TB 512GB, api # master for sanitarium db1125 # net maint
		'db1088' => 500,    # C2 3.6TB 512GB
		'db1093' => 100,    # D2 3.6TB 512GB, api # candidate master # temporary vslow
		'db1096:3316' => 100, # A6 3.6TB 512GB # rc, log: s5 and s6
		# 'db1098:3316' => 1, # B5 3.6TB 512GB # rc, log: s6 and s7 # net maint
		# 'db1113:3316' => 1, # B8 3.6TB 512GB # vslow, dump: s5 and s6 # net maint
	],
	's7' => [
		'db1062' => 0,      # D4 2.8TB 128GB, master
		'db1079' => 300,    # A2 3.6TB 512GB, api # master for sanitarium db1125
		# 'db1086' => 400,    # B3 3.6TB 512GB, api # candidate master # net maint
		'db1090:3317' => 100, # C3 3.6TB 512GB, vslow, dump: s2 and s7, old master
		'db1094' => 500,    # D2 3.6TB 512GB
		# 'db1098:3317' => 1, # B5 3.6TB 512GB # rc, log: s6 and s7 # net maint
		'db1101:3317' => 100, # C2 3.6TB 512GB # rc, log: s7 and s8
	],
	's8' => [
		...
		# 'db1099:3318' => 1, # B2 3.6TB 512GB # rc, log: s1 and s8 # net maint
		'db1101:3318' => 1, # C2 3.6TB 512GB # rc, log: s7 and s8
		# 'db1104' => 300,    # B3 3.6TB 512GB, api # candidate master # net maint
...
'externalLoads' => [
	...
	'extension1' => [
		...
		'10.64.48.19' => 2, # db1064, D1 2.8TB 160GB
		'10.64.32.11' => 1, # db1120, C5 3.6TB 512GB
	],
],
