...
'sectionLoads' => [
	...
	's2' => [
		...
		# 'db1122' => 500,    # D6 3.6TB 512GB, api # upgrade mysql
		'db1103:3312' => 200, # A3 3.6TB 512GB # rc, log: s2 and s4
		'db1105:3312' => 200, # C3 3.6TB 512GB # rc, log: s1 and s2
	],
	/* s3 */ 'DEFAULT' => [
	...
	's4' => [
		...
		'db1097:3314' => 150, # D1 3.6TB 512GB # rc, log: s4 and s5 # T217397
		'db1103:3314' => 50, # A3 3.6TB 512GB # rc, log: s2 and s4 # temporary vslow
		# 'db1121' => 1,      # C6 3.6TB 512GB, vslow, dump # master for sanitarium db1125 # schema
	],
	's5' => [
		...
		'db1100' => 100,    # C2 3.6TB 512GB, old master #api # candidate master # T217397
