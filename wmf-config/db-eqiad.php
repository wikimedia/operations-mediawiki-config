...
'sectionLoads' => [
	...
	's2' => [
		...
		# 'db1101' => 1,   # C2 3.6TB 512GB, watchlist, recentchanges, contributions, logpager, old master 2 #T174509
	],
	/* s3 */ 'DEFAULT' => [
		'db1075' => 0,   # A2 3.6TB 512GB, master
		# 'db1038' => 0,   # B2 1.4TB  64GB, vslow, dump, old master # T172679
		'db1044' => 0,   # B2 1.4TB  64GB, #Temporary master for db1095 - new sanitarium #T150802 #temporary vslow #T164488
	...
	's4' => [
		...
		# 'db1081' => 300, # A2 3.6TB 512GB, api #T174509
	...
	's5' => [
		...
		'db1105' => 100,  # C3 3.6TB 512GB #low weight after being provisioned
		'db1106' => 100,  # D3 3.6TB 512GB #low weight after being provisioned
	],
	's6' => [
		'db1061' => 0,   # C3 2.8TB 128GB, master
		'db1030' => 0,   # B1 1.4TB  64GB, vslow, dump
		# 'db1085' => 300, # B3 3.6TB 512GB, api #master for db1102 (sanitarium 3) - T153743 #T174509
		'db1088' => 300, # C2 3.6TB 512GB # temporary api T174509
	...
	's7' => [
		...
		# 'db1034' => 1,   # B2 1.4TB  64GB, watchlist, recentchanges, contributions, logpager #T174509
		'db1039' => 1,   # B2 1.4TB  64GB #temporary recentchanges #T174509
