...
'sectionLoads' => [
	's1' => [
		...
		'db1067' => 1,     # D1 2.8TB 160GB, old master # candidate master # temporary vslow
		...
		# 'db1106' => 50,      # D3 3.6TB 512GB, vslow, dump # master for db1095 (sanitarium) # dumping enwiki
	...
	's2' => [
		...
		# 'db1090' => 500,    # C3 3.6TB 512GB, upgrading and cloning to db1122
	...
	's4' => [
		...
		'db1081' => 300,    # A2 3.6TB 512GB, api # candidate master
	...
	's6' => [
		...
		# 'db1085' => 300,    # B3 3.6TB 512GB, api #master for db1102 (sanitarium 3) # alter table
	...
	's7' => [
		...
		'db1069' => 0,      # A1 2.8TB 160GB, vslow, dump, old master # candidate master
	...
	's8' => [
		...
		# 'db1109' => 500,    # D8 3.6TB 512GB, depooled for reimage
	],
