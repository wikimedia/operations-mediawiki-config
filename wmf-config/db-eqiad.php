...
'sectionLoads' => [
	's1' => [
		...
		# 'db1080' => 300, # A2 3.6TB 512GB, api #T172679#3650005 #T174509
	...
	/* s3 */ 'DEFAULT' => [
		...
		# 'db1072' => 50,  # B2 2.8TB 160GB, #future vslow and dump - do not pool, talk to marostegui first
		'db1077' => 400, # B1 3.6TB 512GB #temporary special slave - T172679
		'db1078' => 500, # C3 3.6TB 512GB
		'db1103' => 50,  # A3 3.6TB 512GB, watchlist, recentchanges, contributions, logpager
	],
	's4' => [
	...
	's7' => [
		...
		# 'db1079' => 300, # A2 3.6TB 512GB, api #master for db1102 (sanitarium 3) #T174509
...
'readOnlyBySection' => [
	...
	# 'DEFAULT' => 'This request is served by a passive datacenter. If you see this something is really wrong.', # s3
	 's4'      => 'There is a maintenance scheduled from 6AM UTC until 6:30 UTC Wednesday 11th Oct: https://commons.wikimedia.org/wiki/Commons:Village_pump#Read-only_Commons_in_preparation_for_3D_file_support_-_11_October',
