...
'sectionLoads' => [
	...
	/* s3 */ 'DEFAULT' => [
		...
		# 'db1078' => 500,    # C3 3.6TB 512GB, candidate master  # maintenance
	],
	's4' => [
...
'externalLoads' => [
	...
	'cluster25' => [
		...
		'10.64.48.116' => 1, # es1019, D8 11TB 128GB, low load
	],
...
'readOnlyBySection' => [
	...
	# 's2'      => 'This request is served by a passive datacenter. If you see this something is really wrong.',
	 'DEFAULT' => 'read-only due to an emergency maintenance required on the primary database master', # s3
