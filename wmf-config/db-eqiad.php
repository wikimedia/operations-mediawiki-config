...
'sectionLoads' => [
	's1' => [
		...
		'db1067' => 10,     # C6 2.8TB 160GB, old master # candidate master # temporary vslow
		...
		# 'db1106' => 50,     # D3 3.6TB 512GB, vslow, dump # master for db1095 (sanitarium) # temporary stop
	...
	's2' => [
		...
		# 'db1074' => 300,    # A2 3.6TB 512GB, api # master for for db1102 # temporary stop
		'db1076' => 500,    # B1 3.6TB 512GB
		'db1090:3312' => 1, # C3 3.6TB 512GB, vslow, dump: s2 and s7
		'db1122' => 300,    # D6 3.6TB 512GB, api
		'db1103:3312' => 1, # A3 3.6TB 512GB # rc, log: s2 and s4
		'db1105:3312' => 1, # C3 3.6TB 512GB # rc, log: s1 and s2
	],
	/* s3 */ 'DEFAULT' => [
		'db1075' => 0,      # A2 3.6TB 512GB, master
		# 'db1077' => 400,    # B1 3.6TB 512GB, rc, log # master for db1095 # temporary stop
		'db1078' => 400,    # C3 3.6TB 512GB # candidate master # temporary rc
		'db1123' => 100,    # D8 3.6TB 512GB, vslow, dump
	],
	's4' => [
		'db1068' => 0,      # D1 2.8TB 160GB, master
		'db1081' => 100,    # A2 3.6TB 512GB, api # candidate master # temporary vslow
		...
		# 'db1121' => 1,      # C6 3.6TB 512GB, vslow, dump # master for db1102 # temporary stop
	],
	's5' => [
		'db1070' => 0,      # D1 2.8TB 160GB, master
		# 'db1082' => 300,    # A2 3.6TB 512GB, api # master for db1095 # temporary stop
	...
	's6' => [
		...
		# 'db1085' => 300,    # B3 3.6TB 512GB, api #master for db1102 (sanitarium 3) # temporary stop
	...
	's7' => [
		...
		# 'db1079' => 300,    # A2 3.6TB 512GB, api #master for db1102 (sanitarium 3) # temporary stop
	...
	's8' => [
		...
		# 'db1087' => 1,      # C2 3.6TB 512GB, vslow, dump # master for db1095 # temporary stop
		'db1092' => 100,    # D2 3.6TB 512GB, api  # temporary vslow
