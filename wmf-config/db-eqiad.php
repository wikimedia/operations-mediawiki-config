...
$wmgParserCacheDBs = [
	...
	'10.64.0.12'   => '10.64.48.174', # pc1010, D3 4.4TB 256GB # pc1
...
'sectionLoads' => [
	...
	's5' => [
		...
		'db1082' => 400,    # A2 3.6TB 512GB, api # master for sanitarium db1124
		'db1096:3315' => 50, # A6 3.6TB 512GB # rc, log: s5 and s6
		'db1097:3315' => 50, # D1 3.6TB 512GB # rc, log: s4 and s5
		'db1100' => 300,    # C2 3.6TB 512GB, old master #api # candidate master
		#'db1110' => 500,   # T85757 # C3 3.6TB 512GB
		'db1113:3315' => 100, # B8 3.6TB 512GB # vslow, dump: s5 and s6
	],
	's6' => [
