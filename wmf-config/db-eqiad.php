...
$wmgParserCacheDBs = [
	...
	'pc3' => '10.64.48.174',  # pc1010, D3 4.4TB 256GB # spare host. Use it to replace any of the above if needed
];
...
'sectionLoads' => [
	...
	's4' => [
		'db1081' => 0,    # A2 3.6TB 512GB, # master
		...
		'db1138' => 300,     # D8 4.4TB 512GB # candidate master # api
	],
	's5' => [
		'db1070' => 0,      # D1 2.8TB 160GB, master
		'db1082' => 200,    # A2 3.6TB 512GB, api # master for sanitarium db1124
		...
		'db1130' => 500,     # B3 4.4TB 512GB # future candidate master
	],
	's6' => [
	...
	's8' => [
		...
		'db1109' => 300,    # D8 3.6TB 512GB # candidate master # api
		'db1126' => 500,    # A1 4.4TB 512GB
	],
