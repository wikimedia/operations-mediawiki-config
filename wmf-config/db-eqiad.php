...
$wmgParserCacheDBs = [
	...
	'pc3' => '10.64.48.174',  # temporary pc1010 while pc1009 gets rebooted, C3 4.4TB 256GB # pc3
	# 'spare' => '10.64.32.29',  # pc1009, D3 4.4TB 256GB # spare host. Use it to replace any of the above if needed
];
