...
'sectionLoads' => [
	...
	's4' => [
		...
		# 'db1081' => 100,    # A2 3.6TB 512GB, api # candidate master # fixing change_tag table
		...
		# 'db1121' => 1,      # C6 3.6TB 512GB, vslow, dump # master for sanitarium db1125 # fixing change_tag table
	],
	's5' => [
