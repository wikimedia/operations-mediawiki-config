...
'sectionLoads' => [
	...
	's4' => [
		...
		'db1097:3314' => 200, # D1 3.6TB 512GB # rc, log: s4 and s5
		'db1103:3314' => 200, # A3 3.6TB 512GB # rc, log: s2 and s4
	...
	's5' => [
		...
		'db1096:3315' => 250, # A6 3.6TB 512GB # rc, log: s5 and s6
		'db1097:3315' => 250, # D1 3.6TB 512GB # rc, log: s4 and s5
		'db1100' => 50,     # C2 3.6TB 512GB, old master #api # candidate master
		# 'db1110' => 500,    # C3 3.6TB 512GB # alter
	...
	's8' => [
		...
		'db1099:3318' => 50, # B2 3.6TB 512GB # rc, log: s1 and s8
		'db1101:3318' => 50, # C2 3.6TB 512GB # rc, log: s7 and s8
		'db1104' => 50,     # B3 3.6TB 512GB, api # candidate master, temp. vslow
...
'externalLoads' => [
	...
	'cluster25' => [
		...
		'10.64.32.65'  => 1, # es1017, C3 11TB 128GB
