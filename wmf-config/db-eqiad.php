...
'sectionLoads' => [
	...
	's4' => [
		...
		'db1138' => 500,     # D8 4.4TB 512GB # future candidate master
	],
	's5' => [
		'db1070' => 0,      # D1 2.8TB 160GB, master
		'db1082' => 100,    # A2 3.6TB 512GB, api # master for sanitarium db1124
	...
	's7' => [
		...
		'db1090:3317' => 50, # C3 3.6TB 512GB, vslow, dump: s2 and s7, old master
		'db1094' => 500,    # D2 3.6TB 512GB
		'db1098:3317' => 200, # B5 3.6TB 512GB # rc, log: s6 and s7
		'db1101:3317' => 200, # C2 3.6TB 512GB # rc, log: s7 and s8
	],
	's8' => [
...
'externalLoads' => [
	...
	'extension1' => [
		...
		# '10.64.48.19' => 1, # db1064, D1 2.8TB 160GB # to be decommissioned # T217396
