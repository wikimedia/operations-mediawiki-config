...
'sectionLoads' => [
	...
	's7' => [
		...
		# 'db1069' => 0,      # A1 2.8TB 160GB, vslow, dump, old master # moving it to another rack
		'db1079' => 300,    # A2 3.6TB 512GB, api #master for db1102 (sanitarium 3)
		'db1086' => 300,    # B3 3.6TB 512GB, api # temporarily vslow
		'db1094' => 500,    # D2 3.6TB 512GB
		# 'db1098:3317' => 1, # B5 3.6TB 512GB, # rc, log: s6 and s7 # alter table
