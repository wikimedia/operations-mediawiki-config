...
$wmgParserCacheDBs = [
	...
	'pc3' => '10.64.48.174',  # temporary pc1010, D3 4.4TB 256GB # pc3
	# 'spare' => '10.64.32.29',  # temporary pc1009, C3 4.4TB 256GB # spare host. Use it to replace any of the above if needed
];
