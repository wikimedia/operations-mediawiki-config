...
'sectionLoads' => [
	...
	's2' => [
		...
		# 'db1076' => 500,    # B1 3.6TB 512GB # candidate master, api # upgrade mysql
	...
	/* s3 */ 'DEFAULT' => [
		...
		# 'db1077' => 400,    # B1 3.6TB 512GB, rc, log # master for sanitarium db1124 # schema change
		'db1123' => 100,    # D8 3.6TB 512GB, vslow, dump # temporary rc
	],
	's4' => [
