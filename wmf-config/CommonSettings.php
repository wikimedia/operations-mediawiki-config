...
if ( !$globals ) {
	...
	foreach ( array( 'private', 'fishbowl', 'special', 'closed', 'flaggedrevs', 'small', 'mediaviewer',
			...
			'visualeditor-default', 'echowikis', 'cirrus', 'noncirrus' ) as $tag ) {
...
$wgCopyrightIcon = '<a href="//wikimediafoundation.org/"><img src="' . CSSMin::encodeImageAsDataURI( $IP . '/../images/wikimedia-button.png' ) . '" width="88" height="31" alt="Wikimedia Foundation"/></a>';
