...
if ( !$globals ) {
	...
	foreach ( array( 'private', 'fishbowl', 'special', 'closed', 'flaggedrevs', 'small', 'medium',
			...
			'echowikis', 'commonsuploads', 'nonbetafeatures', 'group0' ) as $tag ) {
...
} elseif ( !in_array( $wgDBname, array( 'testwiki', 'labswiki' ) ) && isset( $_SERVER['SERVER_NAME'] ) ) {
