...
if ( $wgDBname === 'labswiki' ) {
	...
	$wgPasswordPolicy['policies']['bureaucrat']['MinimumPasswordLengthToLogin'] = 8;
	$wgPasswordPolicy['policies']['sysop']['MinimalPasswordLength'] = 8;
	$wgPasswordPolicy['policies']['sysop']['MinimumPasswordLengthToLogin'] = 8;
	$wgPasswordPolicy['policies']['bot']['MinimalPasswordLength'] = 8;
	$wgPasswordPolicy['policies']['bot']['MinimumPasswordLengthToLogin'] = 8;
	$wgPasswordPolicy['policies']['default']['MinimalPasswordLength'] = 8;
	$wgPasswordPolicy['policies']['default']['MinimumPasswordLengthToLogin'] = 8;
} else {
