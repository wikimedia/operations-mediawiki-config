...
if ( $wmgUseEducationProgram ) {
	...
	$wgAddGroups['sysop'] = array_merge( $wgAddGroups['sysop'], [ 'eponline', 'epcampus', 'epinstructor', 'epcoordinator' ] ); // T163167
	$wgRemoveGroups['sysop'] = array_merge( $wgRemoveGroups['sysop'], [ 'eponline', 'epcampus', 'epinstructor', 'epcoordinator' ] ); // T163167
}
