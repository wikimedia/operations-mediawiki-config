...
if ( $wgDBname === 'foundationwiki' ) {
	...
	$wgHooks['BeforePageDisplay'][] = function ( $out, $skin ) {
		...
		$cspHeader = "default-src *.wikimedia.org data: blob: 'self'; script-src *.wikimedia.org 'unsafe-inline' 'unsafe-eval' 'self'; style-src  *.wikimedia.org data: 'unsafe-inline' 'self'; report-uri /w/api.php?action=cspreport&format=none&reportonly=1&src=wmfwiki&";
