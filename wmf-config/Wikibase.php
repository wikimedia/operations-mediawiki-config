...
if ( $wmgUseWikibaseRepo ) {
	...
	$wgPropertySuggesterDeprecatedIds = array(
		143, // imported from
		// deprecated properties: see https://www.wikidata.org/wiki/Special:WhatLinksHere/Q18644427
		357, // (OBSOLETE) title (use P1476)
		738, // (OBSOLETE) influence of
		// sandbox properties: see https://www.wikidata.org/wiki/Special:WhatLinksHere/Q18720640
		368, // commonsMedia
		369, // wikibase-item
		370, // string
		578, // time
