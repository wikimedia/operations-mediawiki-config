...
'sectionLoads' => [
	...
	/* s3 */ 'DEFAULT' => [
		...
		'db2074'      => 400, # D6 3.3TB 512GB # InnoDB compressed # sanitarium master
	],
	's4' => [
		'db2051'      => 0,   # B8 2.9TB 160GB, master
		'db2058'      => 50,  # D6 3.3TB 160GB, dump (inactive), vslow # candidate master
		'db2065'      => 200, # D6 3.3TB 160GB, api
		'db2073'      => 400, # C6 3.3TB 512GB # Compressed InnoDB # sanitarium master
	...
	's5' => [
		...
		# 'db2038'      => 0,   # C6 2.9TB 160GB, dump (inactive), vslow, old master # candidate master # alter
		'db2059'      => 100, # D6 3.3TB 160GB, api # temporary vslow
		'db2066'      => 400, # D6 3.3TB 160GB # sanitarium master
		# 'db2075'      => 400, # A1 3.3TB 512GB # Compressed InnoDB # temporary sanitarium in codfw T190704
	...
	's6' => [
		...
		'db2076'      => 400, # B1 3.3TB 512GB # sanitarium master
	...
	's7' => [
		...
		'db2077'      => 400, # C1 3.3TB 512GB # sanitarium master
