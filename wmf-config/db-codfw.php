...
'sectionLoads' => [
	...
	/* s3 */ 'DEFAULT' => [
		...
		'db2057'      => 50,  # D6 3.3TB 160GB # old candidate master
		'db2074'      => 500, # D6 3.3TB 512GB # rc,log # master for sanitarium db2094
		'db2105'      => 500, # A6 5.2TB 512GB # future master
		'db2109'      => 500, # B5 5.2TB 512GB
		'db2127'      => 500, # C6 5.2TB 512GB # future candidate master
	],
	's4' => [
	...
	's5' => [
		...
		'db2066'      => 100, # D6 3.3TB 160GB, api
		'db2075'      => 400, # A1 3.3TB 512GB
		'db2084:3315' => 100, # D6 3.3TB 512GB # rc, log: s4 and s5
		'db2089:3315' => 100, # A3 3.3TB 512GB # rc, log: s5 and s6
		'db2111'      => 100, # B6 5.2TB 512GB
		'db2113'      => 100, # C3 5.2TB 512GB # dump (inactive), vslow future candidate master
		'db2123'      => 100, # B3 5.2TB 512GB # future master
		'db2128'      => 100, # D1 5.2TB 512GB # api # master for sanitarium db2094
	],
	's6' => [
		...
		'db2129'      => 400, # D5 5.2TB 512GB # candidate master
	],
	's7' => [
		...
		'db2121'      => 300, # A5 5.2TB 512GB, # future candidate master
	],
	's8' => [
