...
'sectionLoads' => [
	...
	/* s3 */ 'DEFAULT' => [
		...
		# 'db2050'      => 50,  # C6 2.9TB 160GB dump (inactive), vslow # will clone db2057
		# 'db2057'      => 50,  # D6 3.3TB 160GB # rc, log # candidate master # crashed T212275
		'db2074'      => 500, # D6 3.3TB 512GB # InnoDB compressed # master for sanitarium db2094 # temporary rc # temporary vslow
	],
	's4' => [
