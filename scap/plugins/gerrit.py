...
class GerritEndpoint(object):
    ...
    def post(self, path=None, data={}, **kwargs):
...
class ChangeDetail(GerritEndpoint):
    ...
    def __init__(self, changeid, revisionid='current'):
        ...
        self.review = ReviewDetails(changeid)
