...
class CheckoutMediaWiki(cli.Application):
    ...
    @cli.argument('branch', nargs=1, required=True, metavar='BRANCH',
                  type=VersionParser,
    ...
    def main(self, *extra_args):
        ...
        self.dest_dir = os.path.join(self.config['stage_dir'],
                                     self.arguments.prefix, self.branch)
