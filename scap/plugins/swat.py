...
from scap.plugins.gerrit import Changes, ChangeDetail
...
class Swat(cli.Application):
    ...
    def main(self, *extra_args):
        # todo: write this to self.branch instead
