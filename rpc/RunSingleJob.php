...
try {
	...
	if ( $response['status'] === true ) {
		...
		if ( $response['readonly'] ) {
			...
			// response by 45 seconds in order to minimise the number of requests made by
			// change-prop; this will keep the request rate at a reasonably low level
			// without causing request time outs
