...
// 1F at the begening of the param produces a badvalue_notmultivalue from MW-API
// we still receive a HTTP 200 but the code to parse the response will error out as a 500
// because the json does not contain the expected data.
// Better to send a 400 directly saving a call to the backend.
if ( strpos( $search, chr( 0x1F ) ) === 0 ) {
