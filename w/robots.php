 ...
 *
 * The rules output will be either a global exclusion (Zero, beta) or the
 * concatination of a local robots.txt file and the contents of the
 * [[Mediawiki:robots.txt]] wiki page.
 */
...
if ( isset( $_SERVER['HTTP_X_SUBDOMAIN'] ) &&
	...
	$robotsTitle = Title::newFromText( 'Mediawiki:robots.txt' );
