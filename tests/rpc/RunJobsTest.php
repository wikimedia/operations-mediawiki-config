...
class RunJobsTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @expectedExceptionMessage Request must use POST
	 */
	function testRaiseAnExceptionForNonPost() {
		$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
		$_SERVER['REQUEST_METHOD'] = 'GET';
		require __DIR__ . '/../../rpc/RunJobs.php';
	}

	function testAllowMonitoring() {
		$_SERVER['REMOTE_ADDR'] = '192.0.2.42';
		$_SERVER['REQUEST_METHOD'] = 'GET';
		$_GET['_probe'] = 1;
		require __DIR__ . '/../../rpc/RunJobs.php';
		$this->expectOutputString("Probe successful.\n");
	}
