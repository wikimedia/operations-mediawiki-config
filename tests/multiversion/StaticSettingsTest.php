...
class StaticSettingsTest extends PHPUnit\Framework\TestCase {
	...
	public function testVariantUrlsAreLocalhost() {
		$knownToContainExternalURLs = [
			...
			'wgEntitySchemaShExSimpleUrl', 'wmgWBRepoSettingsSparqlEndpoint', 'wmgWikibaseClientRepoUrl', 'wmgWikibaseClientPropertyOrderUrl', 'wgArticlePlaceholderRepoApiUrl', 'wgMediaInfoExternalEntitySearchBaseUri', 'wgMediaSearchExternalEntitySearchBaseUri', 'wgMediaSearchExternalSearchUri', 'wmgWikibaseSSRTermboxServerUrl', 'wmgWikibaseClientDataBridgeHrefRegExp',
		];
