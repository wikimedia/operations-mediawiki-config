...
class InitialiseSettingsTest extends PHPUnit\Framework\TestCase {
	...
	public function testUrlSettingsAreLocalhost() {
		$knownToContainExternalURLs = [
			...
			'wgCanonicalServer', 'wgServer', 'wgUploadPath', 'wgRedirectSources', 'wgUploadNavigationUrl', 'wgScorePath', 'wgPhonosPath', 'wgUploadMissingFileUrl', 'wgRightsUrl', 'wgWelcomeSurveyPrivacyPolicyUrl', 'wgGlobalRenameDenylist', 'wgWMEClientErrorIntakeURL', 'wgEventLoggingServiceUri', 'wgJwtSessionCookieIssuer',
