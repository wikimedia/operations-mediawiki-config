...
function writeDBList( $listname, $listcontent, $source = 'YAML' ) {
	...
	// This script starts with iterating over all.dblist/all-labs,
	// so it's actually necessary to edit those two files directly,
	// when one's adding a new wiki.
	if ( !in_array( $listname, [ 'all', 'all-labs' ] ) ) {
		array_unshift(
			$content,
